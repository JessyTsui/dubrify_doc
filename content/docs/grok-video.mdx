...
**端点**: `POST https://api.dubrify.com/v1/videos/generations`
...
<Tabs items={['cURL', 'Python']}>
  <Tab value="cURL">
```bash
curl -X POST 'https://api.dubrify.com/v1/videos/generations' \
...
url = "https://api.dubrify.com/v1/videos/generations"
headers = {
    "Authorization": "Bearer YOUR_API_KEY",
